...
Name: Pulse Engine Local
Server group: Servers
Connection tab

Host name/address: localhost
Port: 5434
Maintenance database: pulse_engine
Username: pulse_engine_app
Password: ZQR_8VykVGWVcMQ7vWN6jV6S1qT1chJ-
Save password: On
SSL tab
...
SSL mode: Disable
Important distinction: your app uses postgres:5432 inside Docker, but pgAdmin Desktop connects from Windows, so it must use localhost:5434.
    ...
    Databases
      pulse_engine
        Schemas
          public
            Tables
You should see the app tables there.

to run docker

docker compose -p pulse-v3 --env-file .env up -d
