    ...
    <div className="space-y-6">
      ...
      {isAdmin && (
        <div className="bg-white border border-slate-200 rounded-xl p-4">
          ...
          <p className="text-xs text-slate-400 mb-3">Enter customer IDs to manually merge profiles across platforms.</p>
          <div className="flex items-center gap-3">
            <input value={manualMergeIds[0]} onChange={e => setManualMergeIds([e.target.value, manualMergeIds[1]])}
              placeholder="Customer ID 1" className="flex-1 px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg text-sm font-mono" />
