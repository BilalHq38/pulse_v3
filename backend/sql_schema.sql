...
CREATE TABLE IF NOT EXISTS orders (
    ...
    status           TEXT NOT NULL DEFAULT 'collecting_details'
        CHECK (status IN ('collecting_details','awaiting_confirmation','placed','admin_review','pending','confirmed','cancelled','completed')),
...
ALTER TABLE company_products ADD COLUMN IF NOT EXISTS links TEXT NOT NULL DEFAULT '';
ALTER TABLE company_products ADD COLUMN IF NOT EXISTS link_source TEXT NOT NULL DEFAULT 'auto';
ALTER TABLE company_products ADD COLUMN IF NOT EXISTS slug TEXT NOT NULL DEFAULT '';
ALTER TABLE company_products ADD COLUMN IF NOT EXISTS public_page_enabled BOOLEAN NOT NULL DEFAULT TRUE;
ALTER TABLE company_products ADD COLUMN IF NOT EXISTS stock_quantity INTEGER;
...
CREATE INDEX IF NOT EXISTS idx_company_faqs_company_updated_at ON company_faqs(company_id, updated_at DESC);
...
-- ============================================================================
-- Wave 3b / Wave 6 — opt-in flag for the new conversation engine.
-- Migration 019 added the column with DEFAULT FALSE; migration 020 flipped
-- the default to TRUE and backfilled existing rows. The ADD COLUMN below is
-- kept for fresh bootstraps that skip the incremental migration path.
-- ============================================================================
...
-- ============================================================================
-- Wave 2 — order lifecycle expansion (migration 016).
-- ============================================================================
ALTER TABLE orders DROP CONSTRAINT IF EXISTS orders_status_check;
ALTER TABLE orders ADD CONSTRAINT orders_status_check
    CHECK (status IN (
...
-- ============================================================================
-- Wave 2 — conversation engine substrate (migration 017).
-- ============================================================================
...
-- ============================================================================
-- Wave 2 — follow-up scheduler, feedback, engagement, automation log,
-- product relationships (migration 018).
-- ============================================================================
...
-- ============================================================================
-- Agent orchestrator schema mirror for fresh Docker bootstraps.
-- ============================================================================
