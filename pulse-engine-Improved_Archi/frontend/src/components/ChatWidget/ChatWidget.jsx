          ...
          <div className="pulse-widget-messages" ref={listRef}>
            {messages.map((m) => (
              <div key={m.id} className={`pulse-widget-msg pulse-widget-msg-${m.role}`}>
                ...
                {m.role === 'assistant' && Array.isArray(m.productLinks) && m.productLinks.length > 0 ? (
                  <div className="pulse-widget-product-links" data-testid="widget-product-links">
                    {m.productLinks.map((link, idx) => (
                      <a
                        ...
                        className="pulse-widget-product-link"
                      >
                        View product
                      </a>
                    ))}
